...
public class simpleTest
{
    public static void main(String[] args)
    {
        ...
        if (clientID!=-1)
        {
            ...
            int signalVal = vrep.simxGetStringSignal(clientID, "ScannerData",str,vrep.simx_opmode_oneshot_wait);         
                        
            out.initArrayFromCharArray(str.getArray());
            System.out.println("Position: " + out.getArray()[0] + " " + out.getArray()[1] + " " + out.getArray()[2]);
